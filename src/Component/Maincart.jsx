...
const Maincart = (props) => {
    ...
    console.log("hhwehwedvhwedhjwedhjwedhjew" , cartitem)
            ...
            <div className="row">
              <div className="col-lg-3 col-md-12 mb-4 mb-lg-0">
                ...
                <div className="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                  <img src={ `https://plant-shop-production.up.railway.app/${element.product.productimg[0]}`}
              ...
              <div className="col-lg-5 col-md-6 mb-4 mb-lg-0">
                {/* <!-- Data --> */}
                <p><strong>{`${element.product.title} `}</strong></p>
          ...
          <div className="card-body">
            <ul className="list-group list-group-flush">
              ...
              <li
                ...
                <span><strong>$ {order.amountToBePaid}</strong></span>
              </li>
            </ul>
